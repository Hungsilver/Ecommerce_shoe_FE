...
@Component({
  selector: 'app-invoice-da-giao-hang',
  templateUrl: './invoice-da-giao-hang.component.html',
  styleUrls: ['./invoice-da-giao-hang.component.scss']
})
export class InvoiceDaGiaoHangComponent implements OnInit {
  invoices !: any;
  searchQuery: any = {};
  listTotalPage: any = [];
